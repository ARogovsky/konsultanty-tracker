          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Facebook"
                className="text-white hover:text-mipt-pink"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-white/80">65007, Україна, Одеська обл., місто Одеса, вулиця Старопортофранківська, будинок, 107, квартира, 21</span>
              </li>
              <li className="flex items-start">
                <svg className="mr-2 h-5 w-5 flex-shrink-0 text-mipt-pink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
